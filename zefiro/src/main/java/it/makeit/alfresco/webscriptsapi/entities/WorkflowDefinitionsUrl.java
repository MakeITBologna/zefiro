...
public class WorkflowDefinitionsUrl extends GenericUrl implements AlfrescoBaseUrl {

	private static final String PATH = "/workflow-definitions";
	private String pathParam;
	private Set<String> params;

	public WorkflowDefinitionsUrl(URL pHostUrl) {
		super(pHostUrl);
		populateParams();
	...
	private void populateParams() {
		...
		addParam(AlfrescoRESTQueryParamsEnum.EXCLUDE);
	}
