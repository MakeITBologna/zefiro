            ...
            <div class="row jb-toolbar">
              ...
              <div class="col-sm-9 ">
                <div class="pull-right">
                  ...
                  <button ng-show="!relation" type="button" class="btn btn-default btn-sm" title="<fmt:message key=" jsp.results.export.xls
                    "/>" ng-click="jbSearchFormDocument.print('xls')">
                    <i class="fa fa-file-excel-o fa-lg"></i>
                    <fmt:message key="jsp.results.export.xls" />
                  </button>
                </div>
              </div>
            </div>
                ...
                <tr ng-repeat="row in $data track by $index" ng-dblclick="!relation && startEdit($index)">
                  ...
                  <td>
                    <div ng-show="relation">
                      <button type="button" class="btn btn-primary btn-xs" ng-click="select(row.id)">
